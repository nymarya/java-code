...
public class Livro extends ProdutoDuravel {
     ...
     */ 
    public Livro( double preco, String marca, String descricao, LocalDate dataFabricacao, String material, int durabilidade, String autor, String titulo ) {
	super( "Livro", preco, marca, descricao, dataFabricacao, material, durabilidade);
	this.autor = autor;
	this.titulo = titulo;
    }
