...
public class Main {
	...
	public static void main( String [] args ){
		...
		Produto pizza = new Pizza(1, "3 queijos", 40.0, "Sadia", 
			"pizza com desconto", dataFabricacao, dataValidade, 
			"alimenticio", 8, true);


		Chocolate chocolate = new Chocolate(2, "Chocolate meio amargo", 4.50, "Hershey's", 
			"promoçao de dia dos namorados", dataFabricacao, dataValidade, 
			"alimenticio", 42.00, "amendoim");

		Refrigerante refri = new Refrigerante(3, "Guaraná Kuat", 10.0, "Coca-Cola", 
			"refrescante", dataFabricacao, dataValidade, 
			"alimenticio", 500);

		Livro livro = new Livro(4, "A menina a que roubava livros", 80.0, "Intriseca", 
			"classico", dataFabricacao, "papel", 80, "Marcus Zurak", 3);

		Celular celular = new Celular(5, "Galaxy S8", 3800.0, "Samsung", 
			"promoçao", dataFabricacao, "silicio", 4, 16, 12.6, "dourado");

		Carro carro = new Carro(6, "Fiat Uno", 17000.0, "Fiat", "classico", 
